...
names(All.Ns) <- c("ALSPAC","CHAMACOS","GenerationR","HELIX","INMA","ProjectViva")
...
sum(Ns.covs[,6]) #1982
sum(Ns.covs.mutual.boys.only[,6]) #1022
sum(Ns.covs.mutual.girls.only[,6]) #960
                                                
write.csv(Ns.covs,"/panfs/panasas01/sscm/gs8094/EWAS/pat_bmi/meta/meta_results/childhood.samplesize_covs.csv")
write.csv(Ns.covs.mutual.boys.only,"/panfs/panasas01/sscm/gs8094/EWAS/pat_bmi/meta/meta_results/childhood.samplesize_boys.csv")
write.csv(Ns.covs.mutual.girls.only,"/panfs/panasas01/sscm/gs8094/EWAS/pat_bmi/meta/meta_results/childhood.samplesize_girls.csv")
