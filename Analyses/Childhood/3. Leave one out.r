...
pdf("looplots.covs.pat.childhood.pdf",width=6,height=4)
lapply(1:length(covs.pat.loo),draw.loo.plot,list.of.dfs=covs.pat.loo)
dev.off()

pdf("looplots.covs.patmat.childhood.pdf",width=6,height=4)
lapply(1:length(covs.patmat.loo),draw.loo.plot,list.of.dfs=covs.patmat.loo)
dev.off()

pdf("looplots.boys.childhood.pdf",width=6,height=4)
lapply(1:length(boys.loo),draw.loo.plot,list.of.dfs=boys.loo)
dev.off()

pdf("looplots.girls.childhood.pdf",width=6,height=4)
