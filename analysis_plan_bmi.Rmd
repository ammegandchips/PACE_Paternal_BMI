...
### Minimally-adjusted: Paternal BMI + Cells (model name: covs.pat)
Methylation ~ Paternal BMI + SVs for batch + Estimated cell counts

### Minimally-adjusted: Maternal BMI + Cells (model name: covs.mat)
Methylation ~ Maternal BMI + SVs for batch + Estimated cell counts

### Minimally-adjusted: adjusted for other parent's BMI and cells (model name: covs.mutual)
...
4) EWAS variables summary: for the main EWAS model (mutual), a csv file labelled as YOURSTUDY.patbmi.modelname.summary.timepoint.csv. This will contain summary statistics summarising predictor variables. The code will generate these files for you. If you have multiple time points, you will have a csv file for each time point: birth, early.childhood, late.childhood, adolescence, or adult.
