...
Methylation ~ Paternal BMI + SVs for batch + Paternal age + Paternal smoking status + Paternal socioeconomic status + Maternal age + Maternal smoking status + Maternal social class + Parity + Estimated cell counts

### Minimally-adjusted: Maternal BMI + Covariates + Cells (model name: minimal.mat)
Methylation ~ Maternal BMI + SVs for batch + Paternal age + Paternal smoking status + Paternal socioeconomic status + Maternal age + Maternal smoking status + Maternal social class + Parity + Estimated cell counts
...
Methylation ~ Paternal BMI + Maternal BMI + SVs for batch + Paternal age + Paternal smoking status + Paternal socioeconomic status + Maternal age + Maternal smoking status + Maternal social class + Parity + Estimated cell counts
...
2) Extra cohort information: one Excel file labelled as YOURSTUDY.patbmi.cohortinfo.xlsx. This will contain information for each cohort relating to things like normalisation method and number of fathers excluded because of non-paternity. Please download and use the template available at [https://github.com/ammegandchips/PACE_Paternal_BMI/TEMPLATE.patbmi.cohortinfo.xlsx](https://github.com/ammegandchips/PACE_Paternal_bmi/TEMPLATE.patbmi.cohortinfo.xlsx)
...
All the R code to perform these analyses is provided at:  [https://github.com/ammegandchips/PACE_Paternal_BMI/](https://github.com/ammegandchips/PACE_Paternal_BMI/)
