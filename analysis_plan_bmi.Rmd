...
All of the code necessary to run these analyses is provided here [https://github.com/ammegandchips/PACE_Paternal_BMI/blob/master/Rcode.R] (https://github.com/ammegandchips/PACE_Paternal_BMI/blob/master/Rcode.R). We hope that this will lessen the burden for contributing cohorts and it will also ensure that all outputs are consistently formatted. This will significantly reduce the burden on the people conducting the meta-analysis. Therefore, **please use the supplied code**.
